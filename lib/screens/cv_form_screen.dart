...
import 'cv_personal_info_screen.dart';
import 'cv_education_screen.dart';
import 'cv_skills_screen.dart';
import 'cv_projects_experience_screen.dart';
import 'cv_additional_section_screen.dart';
        ...
        children: [
          ...
          Expanded(
            child: PageView(
              ...
              children: [
                CVPersonalInfoScreen(),
                CVEducationScreen(),
                CvSkillsScreen(),
                CVProjectsExperienceScreen(),
                CvAdditionalSectionScreen(),

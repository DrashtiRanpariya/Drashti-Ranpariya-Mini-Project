      ...
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          if (resume.name.isNotEmpty)
            pw.Text(resume.name,
                style: pw.TextStyle(fontSize: 22, fontWeight: pw.FontWeight.bold, color: titleColor)),
          if (resume.role.isNotEmpty) pw.Text(resume.role),
          ...
          if (resume.awards.isNotEmpty) ...[
            ...
            ...resume.awards.map((a) => pw.Column(
              ...
              children: [
                ...
                if (a.description.isNotEmpty) pw.Padding(padding: const pw.EdgeInsets.only(left: 10, top: 2), child: pw.Text(a.description)),
              ],
            )),
          ],
